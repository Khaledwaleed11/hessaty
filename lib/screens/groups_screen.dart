...
class _GroupsScreenState extends State<GroupsScreen> {
  ...
  List<ClassScheduleModel> _getGroupDaySchedules(String groupId) {
    final schedules = _schedules
        .where(
          (schedule) =>
              schedule.groupId == groupId && schedule.weekday == _selectedDay,
        )
        .toList();
                ...
                child: Column(
                  children: [
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Expanded(child: _buildSheetHeader(colors, group)),
                          ...
                          Material(
                            ...
                            child: InkWell(
                              ...
                              child: const SizedBox(
                                width: 42,
                                height: 42,
                                child: Icon(Icons.close_rounded, size: 21),
                              ),
                            ),
                          ),
                        ],
  ...
  Widget _buildSheetHeader(ColorScheme colors, GroupModel group) {
    return Row(
      children: [
        Container(
          width: 52,
          ...
          child: Icon(Icons.groups_rounded, color: colors.onPrimary, size: 25),
        ),
        const SizedBox(width: 12),
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                '${_dayName(group.weekday)} • مجموعة أسبوعية',
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
                style: TextStyle(
                  fontSize: 10,
  ...
  _ScheduleStatusData _getStatusData(ColorScheme colors, ClassStatus? status) {
    switch (status) {
  ...
  Widget _buildNoSchedules(ColorScheme colors, {required VoidCallback onAdd}) {
    return Container(
                ...
                children: [
                  ...
                  SectionHeader(
                    ...
                    subtitle: selectedGroups.isEmpty
                        ...
                        : 'مجموعة واحدة',
                    actionText: selectedGroups.isEmpty ? 'إضافة مجموعة' : null,
                  ...
                  if (selectedGroups.isEmpty)
                    ...
                    ...selectedGroups.map((group) {
                      final daySchedules = _getGroupDaySchedules(group.id);
                            ...
                            return Container(
                              ...
                              child: GroupCard(
                                ...
                                onTap: daySchedules.isEmpty
                                    ? () => _showScheduleDialogForGroup(group)
                                    : () => _showGroupSchedules(
                                        group,
                                        daySchedules,
                                      ),
                                onEdit: () => _showGroupDialog(group: group),
...
class _GroupDialogState extends State<_GroupDialog> {
  ...
  void initState() {
    ...
    _selectedWeekday = widget.group?.weekday ?? widget.defaultWeekday;
  ...
  bool _dayAlreadyHasGroup() {
    for (final group in widget.existingGroups) {
      if (group.id != widget.group?.id && group.weekday == _selectedWeekday) {
        return true;
      }
    }
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      title: Row(
        children: [
          Container(
            ...
            child: Icon(Icons.groups_rounded, color: colors.primary, size: 21),
          ),
              ...
              Container(
                ...
                child: DropdownButtonFormField<int>(
                  ...
                  items: List.generate(7, (index) {
                    ...
                    final alreadyUsed = widget.existingGroups.any(
                      (group) =>
                          group.id != widget.group?.id && group.weekday == day,
                    );
      ...
      actions: [
        ...
        FilledButton(
          onPressed: _isSaving || selectedDayAlreadyUsed ? null : _saveGroup,
          child: _isSaving
              ? const SizedBox(
                  width: 18,
                  height: 18,
